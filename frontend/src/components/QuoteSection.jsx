...
export default function QuoteSection() {
  ...
  const validate = () => {
    ...
    if (tipoSeguro === 'moto') {
      if (!formData.placa_moto) newErrors.placa_moto = 'Placa é obrigatória'
                  ...
                  <div className="animate-fade-in p-6 bg-slate-50 rounded-xl border border-slate-200 mb-5">
                    ...
                    <div>
                      ...
                      <div className="flex flex-wrap gap-3">
                        {simNaoOptions.map(opt => (
                          <div key={opt} className="radio-option">
                            <input {...radioProps('possui_seguro_auto', opt)} id={`possui_auto_${opt}`} />
                  ...
                  <div className="animate-fade-in p-6 bg-slate-50 rounded-xl border border-slate-200 mb-5">
                    ...
                    <div>
                      ...
                      <div className="flex flex-wrap gap-3">
                        {simNaoOptions.map(opt => (
                          <div key={opt} className="radio-option">
                            <input {...radioProps('possui_seguro_moto', opt)} id={`possui_moto_${opt}`} />
